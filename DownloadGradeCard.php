...
<body>
  ...
  <?php
      $retrieve_data=mysqli_query($connection,"select * from Publish_results ");
      $IsOpen;

      if($row_query = mysqli_fetch_assoc($retrieve_data))
      { 
          $IsOpen = $row_query['IsOpen'];
      }
      ...
      { ?>
        ...
        <br> <br>
        <h1 align = "center"> Academic Section hasn't Published Results Yet </h1>
