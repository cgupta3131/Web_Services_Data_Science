        ...
        <ul class="navbar-nav">
          ...
          if(isset($_SESSION['login']) && $_SESSION['login'] == 1){
              if($_SESSION['Designation'] == 'Student'){
                  echo "
                  <li class='nav-item'>
                    <a class='nav-link' href='./select_course.php'>Apply for course</a>
                  </li>
                  <li class='nav-item'>
            ...
            <table class="table">
				...
				?>
                    <tr>
                        ...
                        <button type="submit" name="<?php echo $row['course_id']?>" class="btn btn-success">Apply For Course</button>
                    	</form>
